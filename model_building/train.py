...
Xtrain_path = "hf://datasets/<---repo id---->/tourist-package-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/<---repo id---->/tourist-package-prediction/Xtest.csv"
ytrain_path = "hf://datasets/<---repo id---->/tourist-package-prediction/ytrain.csv"
ytest_path = "hf://datasets/<---repo id---->/tourist-package-prediction/ytest.csv"
...
categorical_features = [
    'TypeofContact', 'Occupation', 'Gender', 'ProductPitched','MaritalStatus','Designation','Passport'
]
# Preprocessor
...
with mlflow.start_run():
    ...
    repo_id = "<---repo id---->/tourist-package-prediction"
    repo_type = "model"
